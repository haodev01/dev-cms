    ...
    <div class="card-body">
      <form action="{{route('roles.store')}}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input value="{{old('name')}}" name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="basic-default-fullname" placeholder="Nhập tên vai trò" />
          @error('name')
        ...
        <div class=mb-3>
          ...
          <div class="row mt-4">
            ...
            <div class="form- !pl-0 col-3 mb-4">
              <input class="form-check-input checkItem" type="checkbox" value="{{$permission->name}}" name="permission[]" />
